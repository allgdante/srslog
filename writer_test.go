...
func TestWriteFormatters(t *testing.T) {
	...
	for _, test := range tests {
		...
		expected := strings.TrimSpace(f(time.Now(), LOG_ERR, "hostname", "tag", "this is a test message"))
...
func TestWriterFramers(t *testing.T) {
	...
	for _, test := range tests {
		...
		expected := strings.TrimSpace(f(DefaultFormatter(time.Now(), LOG_ERR, "hostname", "tag", "this is a test message") + "\n"))
